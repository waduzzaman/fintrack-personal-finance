...
import { Wallet, Mail, Lock, Eye, EyeOff, User, CheckCircle2, TrendingUp } from "lucide-react"
...
export default function RegisterPage() {
  ...
  const features = [
    ...
    "Set and manage budgets effortlessly",
    ...
    <div className="min-h-screen flex">
      ...
      <div className="flex-1 flex items-center justify-center p-8 bg-background relative">
        ...
        <div className="absolute inset-0 -z-10">
          ...
          <div className="absolute bottom-0 right-0 w-64 h-64 bg-chart-2/5 rounded-full blur-3xl" />
        </div>
      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden bg-gradient-to-br from-chart-2 via-chart-2/90 to-primary">
        {/* Background patterns */}
        ...
        <div className="relative z-10 flex flex-col justify-center p-12 text-white">
          ...
          <p className="text-white/80 text-lg mb-8 max-w-md">
            Join thousands of users who have already transformed their financial life with FinTrack.
          </p>
          ...
          {/* Stats preview */}
          <div className="grid grid-cols-3 gap-6 mt-auto pt-8 border-t border-white/20">
            {[
